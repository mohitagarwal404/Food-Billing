...
lblTitle=Label(Tops,font=('arial',60,'bold'),text='JU Cafe',bd=21,bg='black',
...
Noodles = Checkbutton(Food_F,text="Noodles\t\t\t ",variable=var9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='orange',command=chk_Noodles).grid(row=0,sticky=W)
...
txtNoodles.grid(row=0,column=1)
